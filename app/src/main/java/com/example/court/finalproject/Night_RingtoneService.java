...
public class Night_RingtoneService extends Service {
    ...
    private void playMusic(int sound_number) {
        ...
        if (sound_number == 1) {
            ...
            media_song.start();
            // Must upload the songs from the SD card for these to work, functional if /Music/[SONGNAME].[EXTENSION] is written in
